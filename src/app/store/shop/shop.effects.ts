...
export class ShopEffects {
  ...
  public getProductsSuccess$ = createEffect(() => this.actions$.pipe(ofType(ShopActions.getProductsSuccess)), {
    dispatch: false
  })

  public getProductsFailure$ = createEffect(
    () =>
      this.actions$.pipe(
  ...
  public checkoutFailure$ = createEffect(() => this.actions$.pipe(ofType(ShopActions.checkoutFailure)), { dispatch: false })

  public portal$ = createEffect(() =>
    this.actions$.pipe(
  ...
  public portalSuccess$ = createEffect(
    () =>
      this.actions$.pipe(
  ...
  public portalFailure$ = createEffect(() => this.actions$.pipe(ofType(ShopActions.portalFailure)), { dispatch: false })
    ...
    () =>
      this.actions$.pipe(
        ...
        switchMap(({ isSignedIn }) =>
          from(isSignedIn ? this.nav.navigateForward(['tabs', 'join']) : this.nav.navigateForward(['auth'])).pipe(
            switchMap(() =>
              from(
                this.toast.create({
                  message: isSignedIn
